...
var VAR = {
    ...
    require([ "esri/map",  "esri/tasks/GeometryService", "esri/tasks/ProjectParameters", "esri/SpatialReference", "esri/InfoTemplate", "dojo/dom", "dojo/on", "esri/dijit/BasemapToggle", "dojo/domReady!" ], function( Map, GeometryService, ProjectParameters, SpatialReference, InfoTemplate, dom, on, BasemapToggle)  { map = new Map("map", { center: [77.2, 28.6], zoom: 3, basemap: "streets"  });  //initialising map    
